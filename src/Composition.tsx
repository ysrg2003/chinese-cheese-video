...
function StoryboardVisuals({ job, second }: { job: VideoJob; second: number }) {
  ...
  return <>
    ...
    {(primitives.has("files") || primitives.has("ranks") || primitives.has("all_intersections") || primitives.has("piece_anchor") || primitives.has("legal_destinations") || primitives.has("path_lines") || primitives.has("dim_square_interiors") || primitives.has("brighten_lines") || primitives.has("river_band") || primitives.has("palace_x") || primitives.has("central_files")  || primitives.has("territory_split") || primitives.has("palace_piece_anchor") || primitives.has("general_palace_anchor") || primitives.has("palace_entry_points") || primitives.has("route_constraints") || primitives.has("piece_family_anchor")
 || primitives.has("mirror_setup") || primitives.has("coordinate_endpoints") || primitives.has("pressure_marker") || primitives.has("effect_after") || primitives.has("elephant_eye") || primitives.has("river_limit") || primitives.has("constraint_boundary") || primitives.has("concept_focus")) && <svg style={{ position: "absolute", inset: 0, zIndex: 4, opacity }} width="1080" height="1920">
    ...
    {(primitives.has("chariot_open_file") || primitives.has("cannon_screen") || primitives.has("horse_leg") || primitives.has("horse_leg_blocker") || primitives.has("horse_leg_target")) && <svg style={{ position: "absolute", inset: 0, zIndex: 6, opacity }} width="1080" height="1920">
      ...
      {primitives.has("horse_leg_target") && <circle cx={horseTargetPoint.x} cy={horseTargetPoint.y} r="38" fill="rgba(74,154,194,.16)" stroke="#4a9ac2" strokeWidth="9" strokeDasharray="14 10" />}
    </svg>}
    ...
    {primitives.has("cannon_screen") && <><Marker left={screenPoint.x + 118} top={screenPoint.y - 38} opacity={opacity} tone="gold">ONE SCREEN</Marker><Marker left={cannonTargetPoint.x} top={cannonTargetPoint.y - 76} opacity={opacity} tone="red">TARGET</Marker></>}
    {primitives.has("horse_leg") && <Marker left={horsePoint.x} top={horsePoint.y - 92} opacity={opacity} tone="gold">HORSE</Marker>}
